...
export default function Home() {
  return (
    <div>
      ...
      <p className="leading-[25px] mt-8 text-neutral-500 dark:text-neutral-400">
        Beyond tech, I&lsquo;m passionate about effective team leadership and smart work practices. I believe that a team&lsquo;s well-being is central to smooth operations and
