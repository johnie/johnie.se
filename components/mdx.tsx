...
const H1: React.FC<HeadingProps> = ({ children, ...props }) => {
  return (
    <h1 className="text-3xl bg-clip-text text-transparent bg-gradient-to-r from-neutral-800 to-neutral-500 dark:from-neutral-100 dark:to-neutral-400 font-semibold mb-8" {...props}>
      {children}
    </h1>
  );
};
