...
Most note-taking is archaeology. You dig through folders hoping to find something useful. But what if your vault could think _with_ you, surfacing connections, maintaining context, and evolving alongside your understanding?
...
This vault tracks projects, thinking, and reference material. Core principle: capture quickly, structure deliberately.
...
created: YYYY-MM-DD tags: [relevant, tags] status: active | completed | archived
---

## Linking Expectations

- Link inline, not at the bottom. Write "because [[async beats sync]]" not "Related: async-beats-sync"
...
- _Don't_: "API design thoughts"
- _Good_: "GraphQL works best for client-driven queries"
...
Discussed the API refactor. Sarah thinks we should use GraphQL. Mike mentioned performance concerns. Need to follow up. Also talked about the release timeline.
```
...
**Status:** In progress **Next sync:** Jan 27, 2026
```
