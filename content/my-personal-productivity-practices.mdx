...
summary: "Personal productivity habits for capturing ideas, setting reminders, planning time, and finishing tasks, with practical advice on finding routines that work."
---
...
Use [Draft](https://getdrafts.com/) or [Obsidian](https://obsidian.md/). I've written more about [organizing an Obsidian vault with Claude Code](/writing/the-vault-that-thinks-with-you). Make a notebook for everything. Follow this [Lifehacker guide](http://lifehacker.com/5989980/ive-been-using-evernote-all-wrong-heres-why-its-actually-amazing).
